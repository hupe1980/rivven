...
mod tests {
    ...
    fn test_remove_member_triggers_rebalance() {
        ...
        group.add_member("member-1".to_string(), "client-1".to_string(), vec![], vec![]);
        group.add_member("member-2".to_string(), "client-2".to_string(), vec![], vec![]);
    ...
    fn test_sticky_assignment_preserves_assignments() {
        ...
        previous.insert(
            "m1".to_string(),
            vec![
                PartitionAssignment { topic: "topic-1".to_string(), partition: 0 },
                PartitionAssignment { topic: "topic-1".to_string(), partition: 1 },
            ],
        );
        previous.insert(
            "m2".to_string(),
            vec![
                PartitionAssignment { topic: "topic-1".to_string(), partition: 2 },
                PartitionAssignment { topic: "topic-1".to_string(), partition: 3 },
            ],
        );
    ...
    fn test_sticky_assignment_redistributes_on_new_member() {
        ...
        previous.insert(
            ...
            vec![
                PartitionAssignment { topic: "topic-1".to_string(), partition: 3 },
                PartitionAssignment { topic: "topic-1".to_string(), partition: 4 },
                PartitionAssignment { topic: "topic-1".to_string(), partition: 5 },
            ],
        );
        ...
        assert!(m1_kept > 0 || m2_kept > 0, "Sticky assignment should preserve some assignments");
    }
}
