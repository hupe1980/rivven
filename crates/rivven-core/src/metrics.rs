...
/// Legacy metrics registry for backward compatibility
///
/// **Deprecated**: Use `CoreMetrics` methods directly instead.
/// This will be removed in a future version.
#[deprecated(since = "0.2.0", note = "Use CoreMetrics methods directly")]
...
/// Get global metrics registry (legacy compatibility)
///
/// **Deprecated**: Metrics are now recorded via static methods on `CoreMetrics`.
#[deprecated(since = "0.2.0", note = "Use CoreMetrics methods directly")]
pub fn metrics() -> &'static LegacyMetricsAdapter {
    static ADAPTER: LegacyMetricsAdapter = LegacyMetricsAdapter;
    &ADAPTER
}

/// Adapter for legacy code using the old metrics API
pub struct LegacyMetricsAdapter;

impl LegacyMetricsAdapter {
    pub fn messages_appended_total(&self) -> LegacyCounter {
        LegacyCounter("rivven_core_messages_appended_total")
    }
    pub fn messages_read_total(&self) -> LegacyCounter {
        LegacyCounter("rivven_core_messages_read_total")
    }
    pub fn messages_batch_appended_total(&self) -> LegacyCounter {
        LegacyCounter("rivven_core_batch_appends_total")
    }
    pub fn schemas_registered_total(&self) -> LegacyCounter {
        LegacyCounter("rivven_core_schemas_registered_total")
    }
    pub fn schema_lookups_total(&self) -> LegacyCounter {
        LegacyCounter("rivven_core_schema_lookups_total")
    }
    pub fn schema_cache_hits(&self) -> LegacyCounter {
        LegacyCounter("rivven_core_schema_cache_hits_total")
    }
    pub fn schema_cache_misses(&self) -> LegacyCounter {
        LegacyCounter("rivven_core_schema_cache_misses_total")
    }
    pub fn rate_limit_rejections_total(&self) -> LegacyCounter {
        LegacyCounter("rivven_core_rate_limit_rejections_total")
    }
    pub fn circuit_breaker_trips_total(&self) -> LegacyCounter {
        LegacyCounter("rivven_core_circuit_breaker_trips_total")
    }
    pub fn sql_injection_attempts_blocked_total(&self) -> LegacyCounter {
        LegacyCounter("rivven_core_sql_injection_blocked_total")
    }
    pub fn connection_timeouts_total(&self) -> LegacyCounter {
        LegacyCounter("rivven_core_connection_timeouts_total")
    }
    pub fn message_size_limit_exceeded_total(&self) -> LegacyCounter {
        LegacyCounter("rivven_core_message_size_exceeded_total")
    }
    pub fn active_connections(&self) -> LegacyGauge {
        LegacyGauge("rivven_core_active_connections")
    }
    pub fn partition_count(&self) -> LegacyGauge {
        LegacyGauge("rivven_core_partition_count")
    }
    pub fn segment_count(&self) -> LegacyGauge {
        LegacyGauge("rivven_core_segment_count")
    }
    pub fn append_duration_seconds(&self) -> LegacyHistogram {
        LegacyHistogram("rivven_core_append_latency_seconds")
    }
    pub fn batch_append_duration_seconds(&self) -> LegacyHistogram {
        LegacyHistogram("rivven_core_batch_append_latency_seconds")
    }
    pub fn read_duration_seconds(&self) -> LegacyHistogram {
        LegacyHistogram("rivven_core_read_latency_seconds")
    }
    pub fn auth_failures_total(&self) -> LegacyLabeledCounter {
        LegacyLabeledCounter
    }
}

/// Legacy counter wrapper
pub struct LegacyCounter(&'static str);
...
impl LegacyCounter {
    ...
    pub fn add(&self, n: u64) {
        metrics::counter!(self.0).increment(n);
    }

    pub fn get(&self) -> u64 {
        0 // Cannot read from metrics crate
    }
}

/// Legacy gauge wrapper
pub struct LegacyGauge(&'static str);

impl LegacyGauge {
    pub fn set(&self, val: u64) {
        metrics::gauge!(self.0).set(val as f64);
    }

    pub fn inc(&self) {
        metrics::gauge!(self.0).increment(1.0);
    }

    pub fn dec(&self) {
        metrics::gauge!(self.0).decrement(1.0);
    }
...
/// Legacy histogram wrapper
pub struct LegacyHistogram(&'static str);

impl LegacyHistogram {
    /// Record a duration in microseconds (converts to seconds for Prometheus)
    pub fn observe(&self, duration_us: u64) {
        metrics::histogram!(self.0).record(duration_us as f64 / 1_000_000.0);
    }

    pub fn stats(&self) -> LegacyHistogramStats {
        LegacyHistogramStats {
            p50: 0.0,
            p99: 0.0,
            p999: 0.0,
            count: 0,
...
/// Legacy labeled counter wrapper
pub struct LegacyLabeledCounter;

impl LegacyLabeledCounter {
    pub fn inc(&self, label: &str) {
        metrics::counter!("rivven_core_auth_failures_total", "type" => label.to_string())
            .increment(1);
    }
}

/// Legacy histogram stats (not available with metrics crate)
pub struct LegacyHistogramStats {
    pub p50: f64,
    pub p99: f64,
    pub p999: f64,
    pub count: u64,
...
mod tests {
    ...
    fn test_legacy_adapter() {
        ...
        let m = metrics();
        m.messages_appended_total().inc();
        m.messages_appended_total().add(10);
        m.active_connections().set(5);
        m.active_connections().inc();
        m.active_connections().dec();
        m.append_duration_seconds().observe(1000);
        m.auth_failures_total().inc("md5");
    }
}
