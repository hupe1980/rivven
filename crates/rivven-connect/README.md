...
```toml
rivven-connect = { version = "0.0.9", features = ["rdbc-postgres"] }       # PostgreSQL
rivven-connect = { version = "0.0.9", features = ["rdbc-mysql"] }          # MySQL/MariaDB  
rivven-connect = { version = "0.0.9", features = ["rdbc-sqlserver"] }      # SQL Server
