...
[dependencies]
rivven-connect = "0.0.3"
rivven-cdc = { version = "0.0.3", features = ["postgres"] }
rivven-queue = { version = "0.0.3", features = ["kafka"] }

# Or include everything
[dependencies]
rivven-connect = { version = "0.0.3", features = ["full"] }
rivven-queue = { version = "0.0.3", features = ["full"] }
rivven-storage = { version = "0.0.3", features = ["full"] }
rivven-warehouse = { version = "0.0.3", features = ["full"] }
```
